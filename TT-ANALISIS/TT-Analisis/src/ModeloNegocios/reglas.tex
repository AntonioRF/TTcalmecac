...
\begin{BusinessRule}{RN-N10}{Nombre del plan}
	...
	\BRitem{Referenciado por}{\cdtIdRef{CUOE1}{Gestionar planes de Estudios}}
\end{BusinessRule}
...
\begin{BusinessRule}{RN-N12}{Clave de Unidad de Aprendizaje}
	...
	\BRitem{Referenciado por}{\cdtIdRef{CUOE1.5}{Gestionar Unidades de Aprendizaje}}
\end{BusinessRule}
...
\begin{BusinessRule}{RN-N13}{Tipo de unidad de aprendizaje}
	...
	\BRitem{Referenciado por}{\cdtIdRef{CUOE1.5.1}{Registrar unidad de Aprendizaje}}
\end{BusinessRule}
...
\begin{BusinessRule}{RN-N14}{Tipo de formación}
	...
	\BRitem{Descripción}{De acuerdo a las regulaciones del instituto, las unidades de aprendizaje pueden tener uno de los siguientes tipos de formación:
		\begin{Titemize}
			\Titem Formación Institucional
			\Titem Formación Científica-Básica
			\Titem Formación Profesional
			\Titem Formación Terminal e Integración
		\end{Titemize}}
	\BRitem{Referenciado por}{\cdtIdRef{CUOE1.5.1}{Registrar unidad de aprendizaje}}
\end{BusinessRule}
