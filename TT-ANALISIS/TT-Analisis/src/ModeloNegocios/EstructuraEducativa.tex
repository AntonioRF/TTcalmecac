...
\begin{BusinessEntity}{estructuraEducativa}{Estructura educativa}
	...
	\Battr{numero}{Número}{\tdNumerico}{Es el número que se le da al algoritmo que indica el número de veces que se quiere repetir el algoritmo y que estas sean las opciones generadas}{\requerido}{\longitudMax{2}{caracteres}}{Caracteres admitidos: [1-10] .}
...
\begin{BusinessEntity}{grupo}{Grupo}
	...
	\Battr{numero}{Número}{\tdNumerico}{Es el número consecutivo que se le da a los grupos, después de indicar el nivel y turno. Este será el número que lo diferencia de otro grupo }{\requerido}{\longitudMax{2}{caracteres}}{Caracteres admitidos: [1-99] .}
...
\begin{BusinessEntity}{asociacionProfesor}{Asociación de profesor}
	...
	\Battr{turno}{Turno}{\tdPalabra}{Es el turno al cual pertence el profesor. De este sólo existen CM y CV}{\requerido}{\longitudMax{2}{caracteres}}{Caracteres admitidos: CM $|$ CV.}
	
	\Battr{cantidad}{Cantidad}{\tdPalabra}{Es el número de veces en la que se impartirá la unidad de aprendizaje.}{\requerido}{\longitudMax{1}{carácter}}{Caracteres admitidos: [0-4].}
