...
\begin{UseCase}{CUI1.1}{Registrar edificio}{	
	Permite al actor registrar un nuevo edificio que forma parte de la infraestructura de la ESCOM.
}
...
%-------------------------------------------------------------------
	...
	\UCitem{Propósito}{Registrar un edificio que nos permitirá registrar los espacios.}
	\UCitem{Entradas}{
		\begin{UClist}
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Solicita registrar un edifico dando clic en el ícono \btnRegistrar de la pantalla \cdtIdRef{IUI1}{Gestionar Edificios}. 
