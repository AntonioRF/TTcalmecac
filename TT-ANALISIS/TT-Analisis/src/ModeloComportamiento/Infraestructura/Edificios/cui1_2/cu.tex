...
\begin{UseCase}{CUI1.2}{Modificar edificio}{	
	Permite al Subdirector Académico mdoficar un edificio previamente registrado y así mantener actualizada la infraestructura de la ESCOM.
}
	...
	\UCitem{Propósito}{Mantener actualizada la infraestructura de la ESCOM.}
	\UCitem{Entradas}{
		\begin{UClist}
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Solicita modificar un edifico dando clic en el ícono IUModificar de la pantalla \cdtIdRef{IUI1}{Gestionar Edificios}. 
