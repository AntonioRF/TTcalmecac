...
\begin{UseCase}{CUI1.4}{Consultar edificio}{	
	...
	\UCitem{Propósito}{Permite al actor la consulta de los detalles del edificio y los espacios registrados en él.}
	\UCitem{Entradas}{
		\begin{UClist}
			\UCli Ninguna
		\end{UClist}
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Solicita consultar un edifico oprimiendo el botón \cdtButton{Consultar} de la pantalla \cdtIdRef{IUI1}{Gestionar Edificios}. 
