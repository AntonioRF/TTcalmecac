...
\begin{UseCase}{CUI1.5.2}{Modificar Espacio}{	
	Permite al actor modificar un espacio previamente registrado en un nivel de un edificio de la ESCOM.
}
...
%-------------------------------------------------------------------
	...
	\UCitem{Propósito}{Modificar la información de un espacio a fin de que este actualizada para poder asignarlo a un grupo.}
	\UCitem{Entradas}{
		\begin{UClist}
	...
	\UCitem{Salidas}{
		\begin{UClist}
			...
			\UCli \cdtRef{espacio:nivel}{Nivel}: \ioObtener.
			\UCli \cdtRef{espacio:numero}{Número}: \ioObtener.
			\UCli \cdtRef{espacio:nombre}{Nombre}: \ioObtener.
			\UCli \cdtRef{espacio:capacidad}{Capacidad}: \ioObtener.
			\UCli \cdtRef{tipoEspacio:nombre}{Tipo de espacio}: \ioObtener.
			\UCli \cdtRef{tipoLaboratorio:nombreTipoLab}{Tipo de laboratorio}: \ioObtener.
			\UCli \cdtRef{espacio:accesoDiscapacitados}{Acceso a discapacitados}: \ioObtener.
			\UCli \cdtRef{espacio:funciona}{¿Puede ser utilizado?}: \ioObtener.
			\UCli \cdtRef{espacio:observaciones}{Observaciones}: \ioObtener.
			
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \cdtIdRef{IUI1.5}{Gestionar Espacios} indicando que se modificó correctamente.	
		\end{UClist}
	}
...
\begin{UCtrayectoria}
	\UCpaso [\UCactor] Solicita modificar un espacio oprimiendo el botón \cdtButton{Modificar} de la pantalla \cdtIdRef{IUI1.5}{Gestionar Espacios}. 
