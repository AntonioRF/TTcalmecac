...
\UCsection{Atributos}
	...
	\UCitem{Entradas}{
		\begin{UClist}
			\UCli \cdtRef{estructuraEducativa:numero}{Número} de estructuras educativas a generar: \ioEscribir.
		\end{UClist}
	}
	\UCitem{Salidas}{
		\begin{UClist}
			\UCli \cdtIdRef{MSG1}{Operación Exitosa}: Se muestra en la pantalla \cdtIdRef{IUEE1}{Gestionar Estructura Educativa} indicando que el algoritmo se ejecutó correctamente.
		\end{UClist}
	}
