...
\begin{UseCase}{CUEE1}{Gestionar estructura educativa}{	
	Permite al actor registrar una nueva estructura educativa, consultar, modificar y eliminar las existentes de la ESCOM. Esto permitirá mantener la información actualizada y así generar la información que requiere el algoritmo para generar los horarios.
}
