...
\begin{UCtrayectoria}
	...
	\UCpaso[\UCsist] Muestra la pantalla \cdtIdRef{IUEE1}{Gestionar Estructura Educativa} con la información obtenida con los botones \cdtButton{Modificar}, \cdtButton{Eliminar}, \cdtButton{Consultar}, \cdtButton{Asociar profesores}, \cdtButton{Asociar grupos} y el ícono \btnRegistrar. \label{cuee1:gestionar}
\end{UCtrayectoria}
