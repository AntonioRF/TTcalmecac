\subsection{IUOE1.4 Consultar Unidad de Aprendizaje}
...
\subsubsection{Diseño}
	...
	\IUfig[.8]{../ModeloComportamiento/OfertaEducativa/UnidadAprendizaje/cuoe1_5_4/images/IUOE1_5_4}{IUOE1.4}{Consultar Unidad de Aprendizaje}

\subsubsection{Comandos}
\begin{itemize}
	\item \cdtButton{Regresar}: Permite al actor finalizar la consulta de la unidad de aprendizaje, dirige a la pantalla \cdtIdRef{IUOE1}{Gestionar Unidades de Aprendizaje}.
