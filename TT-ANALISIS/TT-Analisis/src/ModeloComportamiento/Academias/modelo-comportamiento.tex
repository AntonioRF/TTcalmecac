...
En este capítulo se describen los casos de uso referentes al registro, modificación y eliminación de la información de las academias de la ESCOM. \bigskip
	...
	\cfinput{ModeloComportamiento/Academias/cua1/cu}
	\cfinput{ModeloComportamiento/Academias/cua1_1/cu}
	\cfinput{ModeloComportamiento/Academias/cua1_2/cu}
	\cfinput{ModeloComportamiento/Academias/cua1_3/cu}
