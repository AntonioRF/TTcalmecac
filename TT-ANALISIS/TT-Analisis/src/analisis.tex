...
\documento{C1--DA}{\Large{Que para cumplir con la opción de titulación curricular en la carrera de: \\ Ingeniería en Sistemas Computacionales}}{\RELEASE{1.0}}%{\DRAFT{\today}} 

%\entregable{}{\Large{TLAMATINIME: Timetabling Problem, Prototipo de Optimización de Horarios en la ESCOM}}
%\entregable{}{ }x
...
%\cfinput{ModeloNegocios/estructuracionAcademica}
%\cfinput{ModeloNegocios/admision}
%\cfinput{ModeloNegocios/gestionAcademica}
%\cfinput{ModeloNegocios/informacion-EstructuraAcademica}
