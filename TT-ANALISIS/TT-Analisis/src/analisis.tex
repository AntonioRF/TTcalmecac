...
%   \section{Pruebas.}	
	\cfinput{ModeloComportamiento/OfertaEducativa/Pruebas}
...
%   \section{Pruebas.}	
\cfinput{ModeloComportamiento/Profesores/Pruebas}


%=====================Prototipo 5=======================================================
%=================================OFERTA EDUCATIVA=============================
\chapter{Prototipo 5: Estructura Educativa}\label{chp:prototipo5}
%	\section{Modelo de negocio}
\cfinput{ModeloNegocios/EstructuraEducativa}

%	\section{Modelo de comportamiento}
\cfinput{ModeloComportamiento/EstructuraEducativa/modelo-comportamiento}

%\section{Interfaces del módulo}
	%\subsection{Grupos}
\cfinput{ModeloInteraccion/EstructuraEducativa/EstructuraEducativa}
\cfinput{ModeloInteraccion/EstructuraEducativa/AsociarProfesores}
\cfinput{ModeloInteraccion/EstructuraEducativa/Grupos}

%   \section{Pruebas.}	
\cfinput{ModeloComportamiento/EstructuraEducativa/Pruebas}
...
\cfinput{ModeloNegocios/EntornoTT/conclusiones}

%=========================================================
\chapter{Trabajo futuro}\label{chp:trabajoFuturo}
\cfinput{ModeloNegocios/EntornoTT/trabajoFuturo}

\chapter{Anexos}\label{chp:anexos}
\cfinput{ModeloNegocios/EntornoTT/Anexos}
